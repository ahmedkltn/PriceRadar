...
> Track and compare product prices from multiple competitors, powered by Python, Airflow, dbt, Django, and React.JS.
...
- **Modern Frontend**: Displays comparative pricing and trends in a React.JS web application
...
**Frontend**
- **React.JS**: React-based web application framework
...
The React.JS frontend displays comparative pricing and trends.
